...
const Footer = () => {
  ...
  const imgSM='https://cdn.discordapp.com/attachments/1096324843877703713/1200679658627280966/image.png?ex=65c70f12&is=65b49a12&hm=cb9f1263cab47830b0e9f2a1ea46dc35ae6b4876baea2de89290af193e8a6650&'
  const imgLG='https://cdn.discordapp.com/attachments/1096324843877703713/1200680738283065395/image.png?ex=65c71013&is=65b49b13&hm=6a52197b9fff3228af9a255173ad29fc76ae125fb7b68885d1cdb7f97486c808&'
  ...
  return (
    <section className="relative bg-[#FFE7B9] overflow-hidden">
      <img className="min-w-[563px] w-full lg:w-[800px] lg:h-[820px] lg:left-[-40px] h-[766px] absolute bottom-0  " 
      src={isLargeDevice ? imgLG : imgSM}
      // src={imgSM}
       alt="train" />

<img className="w-[814px] hidden lg:block absolute   h-[834px]  bottom-0  right-0 " 
      ...
      <div className="w-[338px] mb-[57px] lg:mb-[22px] mx-auto relative rounded-[5px] bg-gray box-border h-[2.81rem] overflow-hidden text-left text-[1rem] text-white font-inter border-t-[1px] border-solid border-dimgray1">
        <div className="absolute top-[0.81rem] left-[7.5rem] font-500">
          Share it on X
        </div>
      </div>

      <div className="w-fit mx-auto pb-[78px] lg:pb-[37px]">
        <div className="w-[17.06rem] lg:w-[33rem] lg:text-[1.19rem] relative text-[0.88rem] text-black text-center inline-block font-inter">
