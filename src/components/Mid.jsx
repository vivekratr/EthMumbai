...
const Mid = () => {
  ...
  const bgImageSmall =
    "https://cdn.discordapp.com/attachments/1096324843877703713/1200599106100396192/image.png?ex=65c6c40c&is=65b44f0c&hm=7b36005e7b8456acc9fa39979fa622c2c041f415a028e4ca53a986ccd4d7b5b8&";
  const bgImageLarge =
    "https://cdn.discordapp.com/attachments/1096324843877703713/1200667150684274758/image.png?ex=65c7036c&is=65b48e6c&hm=b903aa59cbf024525b6f233d6021a67ae7617daa8018ee7e9de4e2b0ef3be204&";
  const vadapavSM =
    "https://cdn.discordapp.com/attachments/1096324843877703713/1200515533393625189/image.png?ex=65c67637&is=65b40137&hm=948d48dbbed9972d6cfb5f162b1cef0a9b2d32c0fe26b92e55dceffba430a264&";
  const vadapavLG =
    "https://cdn.discordapp.com/attachments/1096324843877703713/1200669553290661988/image.png?ex=65c705a8&is=65b490a8&hm=a60019827cd6c5cb49fadbc97b57170de8eda1288e5e20e3cc251c6dd74ec851&";
  const chaiSM =
    "https://cdn.discordapp.com/attachments/1096324843877703713/1200515577555460116/image.png?ex=65c67642&is=65b40142&hm=b59dc90c24fee1d47bc983559fe037e64490c161c30acf6f2a22a356705522a9&";
  const chaiLG =
    "https://cdn.discordapp.com/attachments/1096324843877703713/1200675000554901514/image.png?ex=65c70abb&is=65b495bb&hm=1f1f97369812429c98de662861d2946282e291ddb16e58f58581bb3ea55fb612&";
  React.useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <section className="relative overflow-hidden w-full z-10 bg-[#FFE7B9]">
      ...
      <div
        onClick={() => {
          const redirectUrl = "https://ethmumbai.in/";

          window.open(redirectUrl, "_blank");
        }}
        className="w-[210px] hover:scale-105 transition-transform duration-150 cursor-pointer mb-[88.6px] mx-auto mt-[106px] lg:mt-[140px] relative rounded-[40px] bg-white box-border h-[4.19rem] overflow-hidden text-left text-[1.13rem] text-black  font-[500] border-[0.3px] border-solid border-darkgray"
      >
        <div
